import { order as importedOrder } from "./script.js";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        // Используем локальную копию order, чтобы не перезаписать глобальный объект
        const selectedCategories = Object.keys(importedOrder).filter(
            (key) => importedOrder[key]
        );
    ...
    function displayNotification(message) {
        ...
        notification.style.color = "#ff66b2";
